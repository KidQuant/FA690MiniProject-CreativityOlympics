...
from scrape import fetch_url_content, scrape_resume

st.title("Resume Optimizer")
action = st.radio("Select Action:", ("Create a New Resume", "Update Existing Resume"))
...
if st.button("Process"):
    if (
        ...
        st.write("Similiar resume urls found:")
        ...
        new_resume_content = generate_resume_content(
            keywords=keywords, fetched_resumes=fetched_data
        )
        ...
        st.write("Similar resume url found:")
        st.write(urls_keywords)
